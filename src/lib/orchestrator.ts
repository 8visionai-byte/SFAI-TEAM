...
function systemPlanu(): string {
  ...
  return [
    ...
    '- "czy to wolno / RODO / AI Act / umowa / co musi byc w aplikacji": prawnik-ai (Ada, ryzyko i wymogi), czesto copywriter (Kaja, jak to zaprojektowac zgodnie) i pamiec-zespolu (zapisy o platnosciach).',
    '- "czy da sie to zbudowac / jak to zrobic / czym / ile to skomplikowane": copywriter (Kaja, architektura rozwiazan AI), pamiec-zespolu (godziny na cene), prawnik-ai (gdy dotyka danych osobowych).',
